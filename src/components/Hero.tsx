...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[70vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className="z-10 animate-float">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 mb-6 drop-shadow-sm">
          Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-400">Gan</span>
        </h1>
        <p className="text-xl md:text-2xl text-slate-700 max-w-2xl mx-auto font-medium mb-10 leading-relaxed">
          Building AI-driven tools to enhance productivity and simplify the complex. Welcome to my creative space.
        </p>
